...
use Modules\Conference\Entities\EventContactUs;
use Modules\ContactUs\Entities\ContactUs;

class EventCancelOneToOneMail extends Mailable implements ShouldQueue
{
    ...
    {
        return $this->markdown('mail.event.CancelOneToOneMail')
