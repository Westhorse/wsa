    ...
    <tbody>
        <tr>
            <td valign="top" style="padding:0;Margin:0">
                ...
                @php
                $template = DB::table('email_templates')->where('slug', 'conference_payment_confirmation_email_template')->value('body');
                $faker = Faker\Factory::create();
                $fakeName = $faker->name;
                $fakeAddress = $faker->address;
                $template = str_replace('{{company_name}}', $fakeName, $template);
                $template = str_replace('{{order_date}}', '2024-04-03 13:01:43', $template);
                $template = str_replace('{{company_address_1}}', $fakeAddress, $template);
               @endphp
                                                                                                ...
                                                                                                <td align="left"
                                                                                                    ...
                                                                                                    <h4
                                                                                                        ...
                                                                                                        <a href="#m_-5886451492927562955_m_-7853593322399995091_"
                                                                                                            style="text-decoration:none;color:#333333;font-size:14px">HANYSDEAS
                                                                                                        </a>
                                                                                                    </h4>
                                                                                                    <p
                                                                                            ...
                                                                                            <tr>
                                                                                                <td align="left"
                                                                                                    ...
                                                                                                    <h4
                                                                                                        style="Margin:0;line-height:120%;font-family:arial,'helvetica neue',helvetica,sans-serif">
                                                                                                        <a href="#m_-5886451492927562955_m_-7853593322399995091_"
                                                                                                            style="text-decoration:none;color:#333333;font-size:14px">DR OSADSDS
                                                                                            ...
                                                                                            <tr>
                                                                                                <td align="left"
                                                                                                    ...
                                                                                                    <h4
                                                                                                        style="Margin:0;line-height:120%;font-family:arial,'helvetica neue',helvetica,sans-serif">
                                                                                                        <a href="#m_-5886451492927562955_m_-7853593322399995091_"
                                                                                                            style="text-decoration:none;color:#333333;font-size:14px">
                                                                                                            Welcome Cocktail
                                                                                                        </a>
                                                                                                    </h4>
                                                                                                    <p
