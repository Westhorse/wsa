<div style="width:100%;font-family:lato,'helvetica neue',helvetica,arial,sans-serif;padding:0;Margin:0">
    <div style="background-color:#151719">
        @php
        $template = DB::table('email_templates')->where('slug', 'one_to_one_receiver_request_email_template')->value('body');
        $faker = Faker\Factory::create();
        $fakeEmail = $faker->email;
        $fakeName = $faker->name;
        $fakeNameSecound = $faker->name;
        $sender_company_name = $faker->name;
        $sender_company_city = $faker->name;
        $sender_company_country = $faker->name;
        ...
        $template = str_replace('{{sender_job_title}}', 'CIO', $template);
        ...
        $template = str_replace('{{sender_company_name}}', $sender_company_name, $template);
        $template = str_replace('{{sender_company_city}}', $sender_company_city, $template);
        $template = str_replace('{{sender_company_country}}', $sender_company_country, $template);
