...
<body>
    <table id="customers">
        ...
        <tbody>
            ...
            @foreach (DB::table('contact_people')->where('user_id', $user->id)->pluck('title') as $date)
                <tr>
            ...
            @foreach (DB::table('contact_people')->where('user_id', $user->id)->pluck('name') as $date)
                <tr>
                    <td>Full Name</td>
                    <td>{{ $date }}</td>
                </tr>
            ...
            @foreach (DB::table('contact_people')->where('user_id', $user->id)->pluck('job_title') as $date)
                <tr>
                    <td>job title</td>
                    <td>{{ $date }}</td>
                </tr>
            ...
            @foreach (DB::table('contact_people')->where('user_id', $user->id)->pluck('email') as $date)
                <tr>
                    <td> E-mail </td>
                    <td>{{ $date }}</td>
                </tr>
            ...
            @foreach (DB::table('contact_people')->where('user_id', $user->id)->pluck('cell') as $date)
                <tr>
                    <td> Direct Phone </td>
                    <td>{{ $date }}</td>
                </tr>
            ...
            @foreach (DB::table('contact_people')->where('user_id', $user->id)->pluck('phone') as $date)
                <tr>
                    <td> Cell Number </td>
                    <td>{{ $date }}</td>
                </tr>
            ...
            <tr>
                <td> ReferenceCity </td>
                <td> {{ $user->tradeReferences[2]->city }} </td>
            </tr>
